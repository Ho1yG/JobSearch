...
urlpatterns = [
    ...
    path('create_vacancy/', user_passes_test(user_is_company)(views.createVacancyView), name='create_vacancy_url'),
    ...
    path('company_profile/', user_passes_test(user_is_company)(views.companyProfileView), name='company_profile_url'),
    path('update_vacancy/<int:vacancy_id>/', user_passes_test(user_is_company)(views.updateVacancyView), name='update_vacancy_url'),
    path('delete_vacancy/<int:vacancy_id>/', user_passes_test(user_is_company)(views.deleteVacancyView), name='delete_vacancy_url'),
    path('view_vacancy_url/<int:vacancy_id>/', views.viewVacancyView, name='view_vacancy_url'),
    path('view_vacancy_user_url/<int:applicant_id>/', views.viewUserVacancyView, name='view_vacancy_user_url'),
    path('change_application_status/<int:applicant_id>/', user_passes_test(user_is_company)(views.change_application_status_view), name='change_application_status_url'),
